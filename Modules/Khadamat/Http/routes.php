...
Route::group(['middleware' => ['web' , 'admin_auth', 'admin_locked' , 'can:'.config('permissions.PERMISSION_SERVICES')], 'prefix' => 'administrator/services', 'namespace' => 'Modules\Khadamat\Http\Controllers'], function()
{
    ...
    Route::get('/fileRemove/{service}/{type}', ['as' => 'admin.services.removeFile', 'uses' => 'ServiceController@magazineFileRemove']);
    Route::get('/fileView/{service}/{type}', ['as' => 'admin.services.fileView', 'uses' => 'ServiceController@magazineFileView']);
});
