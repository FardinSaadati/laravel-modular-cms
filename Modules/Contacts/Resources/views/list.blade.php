...
@include('contact::forms._MessageQuickView')
...
<link href="{{asset('assets/plugins/datatables/datatables.min.css')}}" rel="stylesheet" type="text/css" />
<link href="{{ Module::asset('contact:css/module.css') }}" rel="stylesheet" type="text/css" />
@stop
...
<script src="{{ Module::asset('contact:js/module.js') }}" type="application/javascript"></script>
<script>
M6Module.itemList();
</script>
@stop
