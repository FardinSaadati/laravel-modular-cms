...
class PortfolioController extends Controller
{
    ...
    {
        return view('portfolio::list')->with('title' , 'Products  List');
    }
    // -------------------------------------------------------------------------------
    ...
    public function edit(Portfolio $product)
    {
        ...
        return view('portfolio::edit' , compact('product' ,'images' , 'categories',
            'selectedCategories' , 'selectedValue' , 'locales'))->with('title' , 'Edit Product : '.$product->visible_sku);
    }
    // -------------------------------------------------------------------------------
...
//        }
    ...
    public function ajaxFileUpload(Request $request)
    {
        ...
        if($request->ajax()) {
            if($request->file('file'))  {
                $rules = array('file' => 'required|mimes:mp4,ogx,oga,ogv,ogg,webm');
    ...
    // -------------------------------------------------------------------------------
    protected function magazineFileView(Portfolio $product , $type){
...
//            'Content-Disposition' => 'inline',
        ...
        $file = $type === "sheet" ? $product->sheet : $product->file;
