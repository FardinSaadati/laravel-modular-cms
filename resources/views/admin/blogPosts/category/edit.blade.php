        ...
        <div class="panel-body form">
            <div class="panel panel-grey">
                ...
                <div class="panel-body">
                    {!! Form::model($cat , array('route' => ['admin.blogPosts.categories.update' , $cat], 'method' => 'POST' , 'id' => 'AddNewsCategoryForm')) !!}
                    <div class="col-md-12">
                        <div class="row">
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <div class="">
                            <div class="pull-right">
                                <a href="{{route('admin.blogPosts.categories')}}" class="btn btn-danger">Cancel</a>
