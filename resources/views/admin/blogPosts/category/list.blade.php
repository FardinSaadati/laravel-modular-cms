        ...
        <div class="col-md-12 col-xs-12">
            <div class="panel panel-grey">
                <div class="panel-heading">
                    ...
                    <a href="{{route('admin.blogPosts.categories.add')}}" class="btn btn-xs btn-success" style="margin-top: -2px;">+ Add New</a>
                </span>
                </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                @foreach($categories as $cat)
                                    <tr>
                                        <td>
                                            <a href="{{route('admin.blogPosts.categories.edit' , $cat)}}">
                                                {{$cat->title}}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-xs btn-group-solid">
                                                <a href="{{route('admin.blogPosts.categories.edit' , $cat)}}" class="btn blue"><i class="fa fa-edit"></i></a>
                                                <a href="{{route('admin.blogPosts.categories.delete' , $cat)}}" class="btn red confirmation-remove" data-items="{{$cat->posts->count()}}"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
...
@section('footer')
<script>
M6.ajaxStatusChange('blogPosts/categories/AjaxStatusUpdate');
</script>
@stop