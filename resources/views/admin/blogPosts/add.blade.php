        ...
        <div class="panel-body form">
            <div class="panel panel-grey">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(array('route' => 'admin.blogPosts.create', 'method' => 'POST' , 'id' => 'AddNewsForm' , 'files' => true )) !!}
                                        ...
                                        <div class="form-group {{ $errors->has('categories') ? 'has-error' : '' }}">
                                            ...
                                            <div class="input-icon right">
                                                @if($errors->has('categories'))
                                                    <i class="fa fa-exclamation tooltips" data-container="body"></i>
                                                @endif
                                                {!! Form::select('categories[]' , $categories , null , ['class' => 'form-control input-sm select2', 'multiple' , 'style' => 'width: 100%' , 'id' => 'cat_list' ]) !!}
                                        ...
                                        <div class="form-group {{ $errors->has('body') ? 'has-error' : '' }}">
                                            ...
                                            <div class="input-icon right">
                                                @if($errors->has('body'))
                                                    <i class="fa fa-exclamation tooltips" data-container="body"></i>
                                                @endif
                                                {!! Form::textarea('body' , null , ['class' => 'form-control mce' , 'placeholder' => 'Body of the blogPosts']) !!}
