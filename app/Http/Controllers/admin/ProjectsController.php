...
{
    protected  $redirectPath = 'projects/list';
    ...
    public function index()
    {
        ...
        return view('admin.projects.list' , compact('projects'))->with('title' , 'Projects List');
    }
    // -------------------------------------------------------------------------------
    public function add()
    {
        $categories = ProjectCategory::orderBy('title' , 'ASC')->pluck('title', 'id');
        return view('admin.projects.add' , compact('categories'))->with('title' , 'Project Create');
    }
    // -------------------------------------------------------------------------------
    ...
    public function edit(Project $project)
    {
        ...
        return view('admin.projects.edit' , compact('project' , 'categories' , 'selectedCategory'))->with('title' , 'Edit: '.$project->title);
    }
    // -------------------------------------------------------------------------------
    ...
    protected function validatorUpdate(array $data , $project)
    {
        return Validator::make($data, [
            'title' => 'required|max:100',
            'slug'  => 'required|max:100|unique:posts,slug,'.$project->id,
            'image'   => 'image|mimes:jpeg,png,jpg|max:1024'
        ]);
    }
    // -------------------------------------------------------------------------------
    ...
    public function categoryList()
    {
        ...
        return view('admin.projects.category.list' , compact('categories'))->with('title' , 'Categories List');
    }
    // -------------------------------------------------------------------------------
    public function categoryAdd()
    {
        return view('admin.projects.category.add')->with('title' , 'Category Create');
    }
    // -------------------------------------------------------------------------------
    ...
    {
        return view('admin.projects.category.edit' , compact('cat'))->with('title' , 'Edit: '.$cat->title);
    }
    // -------------------------------------------------------------------------------
