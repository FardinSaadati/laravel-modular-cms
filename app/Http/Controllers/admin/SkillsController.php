...
{
    protected  $redirectPath = 'skills/list';
    ...
    public function index()
    {
        ...
        return view('admin.skills.list' , compact('skills'))->with('title' , 'Skills List');
    }
    // -------------------------------------------------------------------------------
    public function add()
    {
        $categories = SkillCategory::orderBy('title' , 'ASC')->pluck('title', 'id');
        return view('admin.skills.add' , compact('categories'))->with('title' , 'Category Create');
    }
    // -------------------------------------------------------------------------------
    ...
    {
        $categories = SkillCategory::orderBy('title' , 'ASC')->pluck('title','id');
        return view('admin.skills.edit' , compact('skill' , 'categories'))->with('title' , 'Edit: '.$skill->title);
    }
    // -------------------------------------------------------------------------------
    ...
    public function categoryList()
    {
        ...
        return view('admin.skills.category.list' , compact('categories'))->with('title' , 'Categories List');
    }
    // -------------------------------------------------------------------------------
    public function categoryAdd()
    {
        return view('admin.skills.category.add')->with('title' , 'Category Create');
    }
    // -------------------------------------------------------------------------------
    ...
    {
        return view('admin.skills.category.edit' , compact('cat'))->with('title' , 'Edit: '.$cat->title);
    }
    // -------------------------------------------------------------------------------
